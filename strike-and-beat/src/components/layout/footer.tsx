  ...
  return (
    <footer className="bg-surface-container-lowest w-full pt-2xl pb-xl border-t border-outline-variant mt-2xl">
      <div className="max-w-container-max mx-auto px-gutter">
        {/* Main Footer Content */}
        <div className="flex flex-col md:flex-row md:justify-between items-center md:items-end gap-y-xl mt-[50px]">
          {/* Brand Section */}
          <Link href="/" className="flex flex-col gap-xs items-center md:items-start group">
            <h2 className="font-display-xl text-[48px] sm:text-[56px] md:text-[80px] leading-[0.8] uppercase text-white tracking-tighter group-hover:text-neon-yellow transition-colors text-center md:text-left">
              STRIKE <span className="text-neon-yellow">&</span> BEAT
            </h2>
          </Link>
          
          {/* Links Section */}
          <nav className="flex flex-col sm:flex-row items-center md:items-end gap-x-lg gap-y-md">
            <Link
