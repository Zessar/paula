...
export const ArtistSchema = z.object({
  ...
  spotify_embed_url: z.string().optional().nullable(),
...
export const EventInfoSchema = z.object({
  ...
  total_breaks: z.coerce.number().int().nonnegative().optional(),
  ...
  contact_phone: z.string().regex(/^\+?[0-9\s-]{9,}$/, "Teléfono inválido").optional().or(z.literal("")),
  contact_hours: z.string().optional(),
  contact_association_title: z.string().optional(),
  contact_association_text: z.string().optional(),
  artists_title: z.string().optional(),
  artists_description: z.string().optional(),
  fights_title: z.string().optional(),
  fights_description: z.string().optional(),
  card_fights_text: z.string().optional(),
  card_artists_text: z.string().optional(),
  card_bars_text: z.string().optional(),
  // Theme
  theme_primary_color: z.string().optional(),
  theme_neon_color: z.string().optional(),
  marquee_speed: z.coerce.number().min(5).max(150).optional(),
  contact_hero_image: z.string().optional().nullable(),
  tickets_hero_image: z.string().optional().nullable(),
});
